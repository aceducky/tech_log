...
import { deleteLogForm } from "@/app/actions/logs";
...
export default function LogViewer({ log, canEdit = false }: LogViewerProps) {
      ...
      <div className="flex justify-between items-start mb-6">
        <div className="flex-1">
          ...
          <div className="flex flex-wrap items-center gap-4 text-sm text-muted-foreground">
            <div className="flex items-center">
              ...
              <span>By {log.author ?? "Unknown"}</span>
            </div>
            <div className="flex items-center">
        ...
        {canEdit && (
          <div className="ml-4 flex items-center gap-2">
            <Link href={`/log/edit/${log.id}`} className="cursor-pointer">
            ...
            <form action={deleteLogForm}>
              <input type="hidden" name="id" value={String(log.id)} />
              <Button
                type="submit"
                variant="destructive"
